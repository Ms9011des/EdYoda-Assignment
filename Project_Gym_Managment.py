class Gym:
    ...
    def super_user(self):
        ...
        while super_val != '9':
            if super_val == '1':
                ...
                for number, i in enumerate(self.BMI_tables):
                    print(number + 1, ':   ' + i)
                selection = input('Select from above (Enter table title/ Enter 0 to cancel): ')
                while (selection not in self.BMI_tables) and (selection != '0'):
                    selection = input('Entered regimen table does not exist (Enter table title/ Enter 0 to cancel): ')
                if selection != '0':
                    self.BMI_tables.pop(selection)
                    self.create_regimen()
            print('\n1:   Create Member\n2:   View Member\n3:   Delete Member\n4:   Update Member\n5:   Create Regimen'
    ...
    def create_regimen(self):
        regimen_name = input('Enter Regimen Title (Enter 0 to cancel): ')
